...
//
        ...
        Cache cache = new Cache(new File(SevenElevenWeather.getInstance().getApplicationContext().getCacheDir(), "http"), SIZE_OF_CACHE);
    ...
    private static final Interceptor REWRITE_RESPONSE_INTERCEPTOR_OFFLINE = new Interceptor() {
        ...
        public okhttp3.Response intercept(Chain chain) throws IOException {
            ...
            if (!HttpUtil.isNetworkAvailable(SevenElevenWeather.getInstance().getApplicationContext())) {
